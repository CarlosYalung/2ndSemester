...
public static String hashPassword(String password) {
  ...
  void displaytable() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Refund Request");
        ...
        jPanel10.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 60));

        jPanel4.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 20, 160, 60));
        ...
        jPanel19.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 160, 60));

        jPanel7.add(jPanel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, 160, 60));
...
if(result == javax.swing.JOptionPane.OK_OPTION){
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try {
            ...
            if(rowsUpdated > 0) {
                JOptionPane.showMessageDialog(this, "Refund Approved! Item is now marked as Refunded.");
            } else {
                JOptionPane.showMessageDialog(this, "Record Error: Could not find Item ID " + itemID + " in purchases.");
            }
